...
/** Reset the shared state — call on session_start to avoid cross-session leakage. */
export function resetSessionLiveIndexState(): void {
  sessionLiveIndexState.inProgress = false;
  sessionLiveIndexState.promise = null;
}
